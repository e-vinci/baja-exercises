...
public class TextResource {
    ...
    public Text createOne(Text text) {
        if (text == null || text.getContent() == null || text.getLevel() == null // if level is unauthorized, level = null
        ...
        text.setId(texts.size() + 1); // we will improve later the id (issue if we delete items, we could get doublons within ids)
