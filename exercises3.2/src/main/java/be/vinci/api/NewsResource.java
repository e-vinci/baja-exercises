...
public class NewsResource {
    ...
    public List<News> getAll(@DefaultValue("0") @QueryParam("page-id") int pageId, @Context ContainerRequest request) { // request is fed by AnonymousOrAuthorizeRequestFilter
